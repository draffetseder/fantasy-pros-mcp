...
class FantasyProsServer {
                ...
                if (axios.isAxiosError(error)) {
                    return {
                        content: [
                            {
                                type: 'text',
                                text: `FantasyPros API error: ${error.response?.data?.message || error.message}`,
                            },
                        ],
                        isError: true,
                    };
    ...
    async getRankings(args) {
        ...
        const response = await this.axiosInstance.get(`/${sport}/${season}/consensus-rankings`, { params });
        return {
            content: [
                {
                    type: 'text',
    ...
    async getProjections(args) {
        ...
        const response = await this.axiosInstance.get(`/${sport}/${season}/projections`, { params });
        return {
            content: [
                {
                    type: 'text',
